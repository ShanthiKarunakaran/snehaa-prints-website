    ...
    <section className="min-h-screen relative flex items-center justify-center pt-20 pb-32 px-6 overflow-hidden bg-gradient-to-br from-[#F8FAFF] via-[#EDF2FF] to-white">
      <div className="container mx-auto relative">
        <div className="max-w-3xl mx-auto text-center space-y-8 sm:space-y-10">
          <span className="px-3 py-1 text-sm font-semibold bg-blue-50 text-black rounded-full inline-block shadow-sm animate-fadeIn">
            Introducing Our Product
          </span>
          
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight text-black animate-fadeIn">
            Transform Your Experience
          </h1>
          
          <p className="text-lg sm:text-xl text-black/80 max-w-2xl mx-auto px-4 sm:px-0 leading-relaxed animate-fadeIn">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4 animate-fadeIn">
            ...
            <Button
              variant="outline"
              size="lg"
              className="w-full sm:w-auto min-w-[160px] border-2 border-blue-200 bg-white hover:bg-blue-50 text-black shadow-md hover:shadow-lg transition-all duration-300"
            >
              Learn More
            </Button>
          </div>
